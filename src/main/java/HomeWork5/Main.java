...
public class Main {
    public static void main(String[] args) {
        File file = new File("src/main/java/HomeWork5/test.csv");
        try {
        ...
        try (BufferedWriter bufferedWriter = new BufferedWriter(
                new FileWriter("src/main/java/HomeWork5/test.csv"))) {
        ...
        try (BufferedWriter bufferedWriter = new BufferedWriter(
                new FileWriter("src/main/java/HomeWork5/test.csv", true))) {
        ...
        try (BufferedReader bufferedReader = new BufferedReader(
                new FileReader("src/main/java/HomeWork5/test.csv"))) {
